...
{
    public interface IDeleteGlobalApplicationSettingBusinessService
    {
		...
		OperationResult DeleteBySettingName(string settingName);
		...
		/// <returns>List of  Global Application Setting</returns>
		OperationResult DeleteByUserID(string userID);
