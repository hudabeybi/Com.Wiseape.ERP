...
{
    public interface IDeleteGlobalApplicationSettingTemplateBusinessService
    {
		...
		OperationResult DeleteByApplicationSettingName(string applicationSettingName);
		...
		/// <returns>List of  Global Application Setting Template</returns>
		OperationResult DeleteByApplicationSettingValue(string applicationSettingValue);
